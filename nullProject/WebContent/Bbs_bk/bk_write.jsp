...
<div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
      <form action="Bbs_bkAdd.bk" method="post" enctype="multipart/form-data" accept-charset="utf-8">
      	<table>
      		<tr>
	      		<td style="width: 22%;" >
	      		...
	      		<td  style="width: 73%;"><input type="text" name="BK_SUBJECT" class="form-control" placeholder="제목"></td>
      		</tr>
      		<tr >
      			<td style="width: 22%;"><input type="text" name="BK_PRICE" class="form-control" placeholder="가격"></td>
      			<td style="width: 5%;"></td>
      			<td style="width: 73%;"><input type="text" name="BK_PASS" class="form-control" placeholder="비밀번호"></td>
      		</tr>
      	</table>
        <span>&nbsp;</span>   
        <textarea class="form-control" name="BK_CONTENT" rows="25">내용</textarea>
