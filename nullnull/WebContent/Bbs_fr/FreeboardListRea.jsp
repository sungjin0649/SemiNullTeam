...
<script>
      ...
      $("#rec").click(function(){
       ...
       $("#enr").click(function(){
    	   location.href="FrListEnr.okybo";
       })
 


       $("#rea").click(function(){
    	   location.href="FrListRea.okybo";
       })
...
<div  align="left">분류&nbsp;&nbsp;&nbsp;
                     <button type="button" class="cate0" value="0">전체</button>&nbsp;&nbsp;&nbsp;
                     <button type="button" class="cate1" value="1">잡담</button>&nbsp;&nbsp;&nbsp;
                     <button type="button" class="cate2" value="2">이벤트</button>&nbsp;&nbsp;&nbsp;
                     <button type="button" class="cate3" value="3">궁금해요</button>&nbsp;&nbsp;&nbsp;
                     <button type="button" class="cate4" value="4">정보</button>&nbsp;&nbsp;&nbsp;
                     <button type="button" class="cate5" value="5">기사</button>
</div>			
<br><br><br>
   ...
   <tbody>
	...
	<div class="center-block">
		  <ul class="pagination justify-content-center">		
			 ...
			 <c:if test="${page > 1 }">			
				<li class="page-item">
				   <a href="FrListRea.okybo?page=${page-1}" 
