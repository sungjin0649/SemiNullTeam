	...
	<div class="container">
		...
		<div class="movie_form">
			<div class="info_movie">
				...
				<div class="movieinfo">
					<ul>
						...
						<li><span>영화 장소 : <%=request.getParameter("place") %></span> <span id="movieplace"></span></li>
						<li><span>영화 날짜 : <%=request.getParameter("date") %></span> <span id="moviedate"></span>
						</li>
						<li><span>시간 : <%=request.getParameter("time") %></span> <span id="movietime"></span></li>
						<li><span>인원 : <%=request.getParameter("count") %></span> <span id="moviepeoples"></span></li>
					</ul>
				</div>
			...
			<div class="seat_movie">
				...
				<br> <span>선택한 좌석은 :&emsp; </span> <span id="span1" name ="span1"></span>
			</div>
		</div>
