  ...
  <table class="table table-striped">
   ...
   <div class="center-block">
        <ul class="pagination justify-content-center">      
          ...
          <c:if test="${page > 1 }">         
            <li class="page-item">
               <a href="Bbs_bkListRea.bk?page=${page-1}" 
         ...
         <c:forEach var="a" begin="${startpage}" end="${endpage}">
            ...
            <c:if test="${a != page }">
                <li class="page-item">
                  <a href="Bbs_bkListRea.bk?page=${a}" 
                  class="page-link">${a}</a>
                </li>   
            </c:if>
         </c:forEach>
...
<form class="navbar-form navbar-right" method="get" action="RvList.rv" name="search">
      <div class="form-group">
         <select name="searchType" id="searchType">
            <option value="submov"${(searchType =="submov")? "selected" : ""}>영화제목</option>
