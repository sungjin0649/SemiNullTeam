...
public class Bbs_bkListEnrAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		 Bbs_bkDAO boarddao = new Bbs_bkDAO();
	      ...
	      int listcount ;
	      //리스트를 받아옵니다.
	         boardlist = boarddao.getBoardEnrList(page,limit);
	         listcount =  boarddao.bbs_bkListCount();
	...
	= (DB에 저장된 총 리스트의 수 + 한페이지에서 보여주는 리스트의수 -1) / 한페이지에서 보여주는 리스트의 수
	      ...
	      if(state ==null) {
	         ...
	         forward.setPath("Bbs_bk/bk_listEnr.jsp"); //바꿔야함
	         return forward;
	      }else {
